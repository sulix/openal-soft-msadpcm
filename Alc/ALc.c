...
static const ALCenums enumeration[] = {
    ...
    DECL(AL_FORMAT_MONO_MSADPCM64),
    DECL(AL_FORMAT_STEREO_MSADPCM64),
    DECL(AL_FORMAT_MONO_MSADPCM128),
    DECL(AL_FORMAT_STEREO_MSADPCM128),
    DECL(AL_FORMAT_MONO_MSADPCM256),
    DECL(AL_FORMAT_STEREO_MSADPCM256),
...
static const ALchar alExtList[] =
    ...
    "AL_SOFT_source_latency AL_EXT_MSADPCM";
